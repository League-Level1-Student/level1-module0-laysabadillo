	...
	private void startQuiz() {
		...
		// 2. Set the size of the window in the initializeGui() method below
			...
			if (guess.equals("Arnold")) {
				...
				JOptionPane.showMessageDialog(null, "It Was Arnold");
			}
			...
			if (guess.equals("Leonardo")) {
				...
				JOptionPane.showMessageDialog(null, "It Was Leonardo");
			}
			JOptionPane.showMessageDialog(null, "Your Score Is " + score);
			showNextImage();
			...
			if (guess.equals("Morgan")) {
				...
				JOptionPane.showMessageDialog(null, "It Was Morgan");
			}
			JOptionPane.showMessageDialog(null, "Your Score Is " + score);
			showNextImage();
			...
			if (guess.equals("Jack")) {
				...
				JOptionPane.showMessageDialog(null, "It Was Jack");
				JOptionPane.showMessageDialog(null, "Your Score Is " + score);
